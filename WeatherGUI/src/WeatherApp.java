...
// check if data exist
        ...
        if (locationData == null) {
            // Handle null locationData
            weatherCondition = "None";
            latitude = 0;
            longitude =0;
        }
        else{
            location = (JSONObject) locationData.getFirst();
        ...
        "&longitude=" + longitude + "&hourly=temperature_2m,relative_humidity_2m,rain,snowfall,weather_code,wind_speed_10m&timezone=America%2FNew_York&forecast_days=1");
        ...
        try{
            ...
            // get wind speed
            JSONArray windSpeed10m = (JSONArray) hourly.get("wind_speed_10m");
            double windSpeed = (double) windSpeed10m.get(index);
            if(windSpeed > 25.00){
